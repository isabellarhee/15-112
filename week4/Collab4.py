...
def resetApp(app):
    ...
    app.margin = 5
    app.paddleSpeed = 10
    app.paddleColor = "black"
    app.dotsLeftColor = "black"
    app.dotColor = "black"
    app.dotR = 15
    app.gameOver = False
    app.paused = False
    resetDot(app)
    app.colorfulMode = False
    app.colorR = 100
    app.colorG = 100
    app.colorB = 100
...
def colorfulMode(app):  
    if app.dotsLeft <= 2:
        app.dotsLeftColor = 'red'
    
    app.paddleColor = 'pink'

    app.colorR = int((app.dotCy / 300) * 255)
    app.colorG = int((app.dotCx / 400) * 255)
    app.colorB = int((math.sqrt((app.dotCx**2) + (app.dotCy**2)) / 500 ) * 255)
    print ("r, g b: %d , %d, %d")

    app.dotColor = rgbString(app.colorR, app.colorG, app.colorB)

def rgbString(r, g, b):  #from notes 
